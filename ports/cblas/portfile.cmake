...
if(VCPKG_TARGET_IS_WINDOWS)
    if(EXISTS "${CURRENT_PACKAGES_DIR}/lib/libcblas.lib")
        file(RENAME "${CURRENT_PACKAGES_DIR}/lib/libcblas.lib" "${CURRENT_PACKAGES_DIR}/lib/cblas.lib")
    endif()
    if(EXISTS "${CURRENT_PACKAGES_DIR}/debug/lib/libcblas.lib")
        file(RENAME "${CURRENT_PACKAGES_DIR}/debug/lib/libcblas.lib" "${CURRENT_PACKAGES_DIR}/debug/lib/cblas.lib")
    endif()
endif()
